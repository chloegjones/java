...
public class PlayerController implements Initializable {
    ...
    private final Integer[] bandsList = {1, 2, 4, 8, 16, 32, 40, 64, 100};
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        visualizers.add(new Cgjnd7SpaceVisualizer());
    ...
    private void handleVisualize(double timestamp, double duration, float[] magnitudes, float[] phases) {
        Duration ct = mediaPlayer.getCurrentTime();
        double ms = ct.toSeconds();
        currentText.setText(String.format("%.1f s", ms));
